...
import ForImportDefault, { ForImportNamed } from "./es-modules/ForImport.mjs";
ForImportDefault();
ForImportNamed();
...
const cjs = require("./cjs-modules/ForCreateRequire.js");
...
import cjs2 from "./cjs-modules/ForRequire.js";
